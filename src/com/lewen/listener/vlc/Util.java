...
public class Util {
    ...
    public static LibVLC getLibVlcInstance() throws LibVlcException {
        ...
        if (instance == null) {
            ...
            Context context = TBApplication.App;
    ...
    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = TBApplication.App.getResources().getAssets().open(assetName);
...
//
    ...
    public static boolean isPhone(){
        TelephonyManager manager = (TelephonyManager)TBApplication.App.getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
