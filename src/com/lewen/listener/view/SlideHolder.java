...
public class SlideHolder extends FrameLayout {
	...
	/**
	 * 
	 * @param direction - direction in which SlideHolder opens. 
	 * Can be: DIRECTION_LEFT, DIRECTION_RIGHT
	 */
	 ...
	 * 
	 * @param allow - 
	 * if false, SlideHolder won't react to swiping gestures (
	 * but still will be able to work by manually invoking
	 *  mathods)
	 */
	...
	/**
	 * 
	 * @param dispatch - if true, 
	 * in open state SlideHolder will dispatch touch events to 
	 * main layout (in other words -
	 ...
	 * 
	 * @param opened - 
	 * if true, SlideHolder will always be in opened state (
